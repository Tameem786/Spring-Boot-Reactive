package com.zaman.ReactiveProgrammingJava.controller;

import com.zaman.ReactiveProgrammingJava.domain.Quote;
import com.zaman.ReactiveProgrammingJava.repository.QuoteMongoBlockingRepository;
...
public class QuoteBlockingController {
    ...
    public Iterable<Quote> getQuotesBlocking(
            final @RequestParam(name = "page") int page,
            final @RequestParam(name = "size") int size
    ) throws Exception {
        Thread.sleep((long) DELAY_PER_ITEM_MS * size);
